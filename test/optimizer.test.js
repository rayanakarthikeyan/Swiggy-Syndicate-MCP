...
const swiggy_mcp_client_1 = require("../src/client/swiggy-mcp-client");
const constraint_optimizer_1 = require("../src/engine/constraint-optimizer");
const bill_splitter_1 = require("../src/engine/bill-splitter");
async function runTests() {
    console.log("=== RUNNING SWIGGY SYNDICATE UNIT & INTEGRATION TESTS ===");
    const client = new swiggy_mcp_client_1.SwiggyMcpClient({ useSandboxFallback: true });
    const optimizer = new constraint_optimizer_1.GroupConstraintOptimizer(client);
    ...
    const billSplit = bill_splitter_1.GroupBillSplitter.computeSplit({
        cartData: liveCart,
